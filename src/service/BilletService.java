...
public class BilletService implements IService<Billet> {
    ...
    public int insertID(Billet billet) {
        ...
        String sql = "insert into billet values(null, ?, ?, ?,47)";
    ...
    public List<Billet> getAll() {
        String sql = "select * from (SELECT m.id_billet, m.bloc,m.prix_billet, m.id_match,m.nb_but1,m.nb_but2, m.stade, m.id_arbitre1, b1.nom nom_arbitre1,b1.email email_arbitre1, b1.prenom prenom_arbitre1, "
