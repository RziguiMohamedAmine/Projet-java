...
public class Match {
    ...
    public String toString() {
        return "\nMatch{" + "id=" + id + ", nb_but1=" + nb_but1 + ", nb_but2=" + nb_but2 + ", stade=" + stade + ", nb_spectateur=" + nb_spectateur + ", equipe1=" + equipe1 + ", equipe2=" + equipe2 + ", arbiter1=" + arbiter1 + ", arbiter2=" + arbiter2 + ", arbiter3=" + arbiter3 + ", arbiter4=" + arbiter4 + ", date=" + date + ", saison=" + saison + ", round=" + round + '}';
    }
