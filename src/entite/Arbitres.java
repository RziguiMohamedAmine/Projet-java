...
public class Arbitres {
   ...
   String  nom;
    ...
    public Arbitres(int id, String nom, String prenom, int id_role, String image, int age) {
        this.id = id;
        this.nom = nom;
        this.prenom = prenom;
    ...
    public Arbitres(String nom, String prenom, int id_role, String image, int age) {
        this.nom = nom;
        this.prenom = prenom;
        this.id_role = id_role;
        this.image = image;
